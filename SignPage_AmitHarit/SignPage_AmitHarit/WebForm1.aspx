...
<body>
    <form method ="post" action="">
        <div class="register">
    <input class ="fName" name="fName" id ="fName" placeholder="first name"/> <br />
    <input class ="lName" name="lName" id ="lName" placeholder="last name"/> <br />
    <input class ="username" name="username" id ="username" placeholder="username"/> <br />
    <input class ="email" name="email" id ="email" placeholder="email"/> <br />
    <input class ="id" name="id" id ="id" placeholder="id"/> <br />
    <input class ="Pass" name="Pass" id ="Pass" placeholder="password"/> <br />
    <input class ="conPass" name="conPass" id ="conPass" placeholder="confirm password"/> <br />
